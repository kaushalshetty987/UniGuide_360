...
import { LayoutDashboard, FileText, CreditCard, Calendar, MessageSquare, BookOpen, Users, LogOut, Home, DollarSign } from 'lucide-react';
...
const Sidebar = ({ isOpen, closeSidebar }) => {
    ...
    const studentLinks = [
        ...
        { icon: Home, label: 'Hostel', path: '/student/hostel' },
    ];

    const parentLinks = [
        { icon: LayoutDashboard, label: 'Overview', path: '/parent' },
        { icon: CreditCard, label: 'Fees & Payments', path: '/parent/fees' },
    ...
    return (
        <>
            ...
            `}>
                <div className="p-4 space-y-1 overflow-y-auto h-full pb-20 flex flex-col">
